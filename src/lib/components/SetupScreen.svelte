...
<div class="overlay">
  <form class="card" onsubmit={submit}>
    <h1>LanProbe</h1>
    <p class="sub">Configuration initiale — créez le compte administrateur.</p>
    <label>
      Nom d'utilisateur
...
<style>
  ...
  .card { background: var(--ep-bg-secondary, #141821); border: 1px solid var(--ep-border, #232832); border-radius: 12px; padding: 32px; width: 360px; display: flex; flex-direction: column; gap: 14px; color: var(--ep-text-primary, #e6e9ef); }
